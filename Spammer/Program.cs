...
namespace Updater
{
    ...
    public class Program
    {
        ...
        {
            SerialCheckerModule serialCheckerModule = new SerialCheckerModule { Index = 1, Name = "Проверка видеоматериалов на сериал" };
            ExtendedModulesParent extendedModulesParent = new ExtendedModulesParent
            {
                Index = 3,
                Name = "Дополнительные модули",
                DependentModules = new IModule[] { serialCheckerModule }
            };

            modules.Add(extendedModulesParent);
